...
CREATE TABLE `promote_ad_info` (
  ...
  `adImageUrl` varchar(1024) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '1200 * 628 图片资源 url',
  ...
  `adBody` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '广告描述信息',
  `callAction` varchar(40) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '按钮显示文本',
  ...
  `targetStartPage` varchar(100) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '包名起始页',
  `targetPackageName` varchar(100) COLLATE utf8_unicde_ci DEFAULT '' COMMENT '目标包名',
...
CREATE TABLE `promote_app_adunit_info` (
  ...
  `desc` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '版位描述',
  `update_time` int(10) unsigned NOT NULL COMMENT '最后更新时间',
